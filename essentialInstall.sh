...
pip3 install cython request bs4 tweepy twython flask django py2app nltk spacy tqdm scikit-learn autobahn nose sqlalchemy keras
...
pip install cython request bs4 tweepy twython flask django py2app nltk spacy tqdm scikit-learn autobahn nose sqlalchemy keras
...
# LAMP
apt-get install -y apache2 mysql-server mysql-client mysql-workbench php libapache2-mod-php phpmyadmin composer
